...
In my repositories, you can find a tip calculator app, a salary calculator app, an AE clone product page, a small Animal Filter App which allows the user to create a database of animals, a version of the good old Rock, Paper, Scissors game with a twist, as well as a couple of apps implementing API data fetching and filtering. 
